...
- AEDMAE 进一步表明，轻量 frame-level masked auto-encoder 配合自蒸馏与 anomaly map 监督，也能在高吞吐场景中取得有竞争力的性能。
...
- [[AEDMAE]] — 高吞吐 masked autoencoder + 自蒸馏路线代表方法。
